...
from clindaws.execution.optimized_candidate_optimization import (
    OptimizedCandidateOptimizationResult,
    optimize_candidate_surface,
)
...
def build_optimized_candidate_fact_bundle(
    ...
    *,
    ...
    optimization = optimize_candidate_surface(
        config,
        ontology,
        tools,
    ...
    return _finalize_fact_bundle(
        ...
        backend_stats={
            ...
            "decompression_mode": decompression_mode or "none",
            "smart_expansion": {
