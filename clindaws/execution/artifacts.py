"""Run artifact filenames and CSV writers."""
...
from clindaws.execution.modes import approach_label
...
def workflow_signatures_filename(
    *,
    config,
    mode: str,
    optimized_enabled: bool,
...
def horizon_record_payload(records: tuple[HorizonRecord, ...]) -> list[dict[str, object]]:
...
class RunSummaryWriter:
    ...
    def __init__(
        ...
        *,
        ...
        self.csv_path = csv_path
        self.base_row = {
            "approach": approach_label(mode, optimized_enabled),
...
class RunCsvWriters:
    ...
    def __init__(
        ...
        *,
        ...
        self.summary_writer = RunSummaryWriter(
